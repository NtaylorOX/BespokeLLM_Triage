...
# load local metrics for OFFLINE machine
preloaded_f1 = load("/home/ec2-user/Code/chronosig_repo/hf_metrics/evaluate/metrics/f1/f1.py")
preloaded_precision = load("/home/ec2-user/Code/chronosig_repo/hf_metrics/evaluate/metrics/precision/precision.py")
preloaded_recall = load("/home/ec2-user/Code/chronosig_repo/hf_metrics/evaluate/metrics/recall/recall.py")
preloaded_accuracy = load("/home/ec2-user/Code/chronosig_repo/hf_metrics/evaluate/metrics/accuracy/accuracy.py")
preloaded_roc_auc = load("/home/ec2-user/Code/chronosig_repo/hf_metrics/evaluate/metrics/roc_auc/roc_auc.py",  "multiclass")
preloaded_roc_auc_binary = load("/home/ec2-user/Code/chronosig_repo/hf_metrics/evaluate/metrics/roc_auc/roc_auc.py",  "binary")  

### FOR USUAL ONLINE MACHINE
...
#### for OFFLINE machine
precision_score = preloaded_precision
recall_score = preloaded_recall
accuracy_score = preloaded_accuracy
f1_score = preloaded_f1        
...
def compute_metrics(predictions, pred_scores, labels):
    ...
    if len(np.unique(labels)) == 2:   
        ...
        roc_auc_score = preloaded_roc_auc_binary
        ...
        roc_auc_score = preloaded_roc_auc
